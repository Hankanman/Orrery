/* Orrery UI kit — Lucide icon set rendered inline (real Lucide path data).
   Lucide is the icon set shipped with shadcn/ui, Orrery's component library. */
const ORR_ICONS = {
...
function Icon({ name, size = 16, sw = 2, style, className }) {
  return (
    <svg className={className} style={{ flex: 'none', ...style }} width={size} height={size}
      viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={sw}
      strokeLinecap="round" strokeLinejoin="round"
      dangerouslySetInnerHTML={{ __html: ORR_ICONS[name] || '' }} />
  );
}

Object.assign(window, { ORR_ICONS, Icon });
